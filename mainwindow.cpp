...
void MainWindow::on_pushButton_2_clicked()
{
    ...
    ui->label_21->setText(QString::number(wynik) + ui->comboBox_4->currentText());
    ui->label_24->setText(QString::number(wynik) + ui->comboBox_4->currentText());
